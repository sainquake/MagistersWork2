...
namespace HaarTesting
{
    public partial class Form1 : Form
    {
        ...
        {
        	serialPort1.PortName = "COM5"; //Указываем наш порт - в данном случае COM1.
       ...
       List<SData> data= new List<SData>();
        ...
        void Timer1Tick(object sender, EventArgs e)
        {
        	ay+=y;
        	ax+=x;
        	serialPort1.WriteLine("par dRoll "+ (-x).ToString() );
        	serialPort1.WriteLine("par dPitch "+ (y).ToString() );
        	//
